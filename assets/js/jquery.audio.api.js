...
if (typeof(AudioContext) == "undefined" && typeof(mozAudioContext) == "undefined") {
...
AudioContext.prototype.loadSound = function (url, strNameOfSoundBufferVariable) {
	var request;
...
AudioContext.orderUrl = function (url) {
...
AudioContext.prototype.prepareRequest = function (url, strNameOfSoundBufferVariable) {
	var context = this;
...
AudioContext.prototype.prepareFallbackRequestForSafari = function (url, strNameOfSoundBufferVariable) {
	var context = this;
	var request = new XMLHttpRequest();
	request.open('GET', url, true);
	request.responseType = 'arraybuffer';
...
AudioContext.prototype.loadFallbackSound = function (url, strNameOfSoundBufferVariable) {
	var context = this;
	var request = new XMLHttpRequest();
	request.open('GET', url, true);
	request.responseType = 'arraybuffer';
...
AudioContext.prototype.playSound = function (strBuffer) {
	var context = this;
